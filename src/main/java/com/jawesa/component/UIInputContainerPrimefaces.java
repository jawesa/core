 ...
 * input components (<strong>EditableValueHolder</strong>), their corresponding message components (<strong>Message</strong>)
 ...
 */
@FacesComponent(UIInputContainerPrimefaces.COMPONENT_TYPE)
public class UIInputContainerPrimefaces extends UIComponentBase implements NamingContainer {
    /**
     * The standard component type for this component.
     */
    public static final String COMPONENT_TYPE = "com.jawesa.component.InputContainerPrimefaces";
    ...
    public UIInputContainerPrimefaces() {
    ...
    protected InputContainerElements scan(final UIComponent component, InputContainerElements elements,
        ...
        if ((elements.getLabel() == null) && (component instanceof HtmlOutputLabel)) {
            ...
            elements.registerMessage((Message) component);
        }
        ...
        public void wire(final FacesContext context) {
            ...
            if (numInputs > 0) {
                ...
                for (int i = 0, len = messages.size(); i < len; i++) {
                    if (i < numInputs) {
                    	String idInput = ((UIComponent) inputs.get(i)).getClientId(context);
                        messages.get(i).setFor(idInput.substring(idInput.lastIndexOf(":")+1));
                    }
                }
            }
        }
